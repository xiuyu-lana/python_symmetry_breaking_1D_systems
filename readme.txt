...
We use tools from QuTiP to solve the Schrodinger equation for this system to get the eigenenergies and eigenfunctions. Then we can plot the band structures using eigenvalues and calculate the linear optical response. For the formula used when calculating the optical response, please refer to the following paper: 
